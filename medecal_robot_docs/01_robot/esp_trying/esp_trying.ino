...
#define API_KEY "AIzaSyDgYIiAuNOpHmbB_5ygswEdXkKEutB4kes"

/* 3. Define the RTDB URL */
#define DATABASE_URL "esp8266project-8be6f-default-rtdb.firebaseio.com" //<databaseName>.firebaseio.com or <databaseName>.<region>.firebasedatabase.app
